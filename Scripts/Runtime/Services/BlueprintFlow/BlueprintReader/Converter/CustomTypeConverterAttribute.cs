...
namespace GameCore.Services.BlueprintFlow.BlueprintReader.Converter
{
    using System;
    ...
    public class CustomTypeConverterAttribute : Attribute
    {
        ...
        {
            this.TypeConverter = Activator.CreateInstance(typeConverterType, constructorArgs) as ICustomTypeConverter ??
