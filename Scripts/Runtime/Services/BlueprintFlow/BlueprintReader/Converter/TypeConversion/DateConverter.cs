namespace GameCore.Services.BlueprintFlow.BlueprintReader.Converter.TypeConversion
{
    using System;
    ...
    public class DateConverter : ITypeConverter
    {
        ...
        public object ConvertFromString(string text, Type typeInfo)
        {
            ...
            {
                DateTime.TryParseExact(text, this.dateFormat, CultureInfo.InvariantCulture,
